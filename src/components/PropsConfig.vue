...
<template>
  <div>
    <div class="sub-panel" v-for="(value, key) in propsConfig" :key="key">
      ...
      <template v-else-if="getConfigType(key) === 'table-data-source'">
        <div>
          <TableDataConfig
            :prop-value="propsConfig[key]"
...
import TableDataConfig from './TableDataConfig.vue';
